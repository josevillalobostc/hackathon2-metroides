    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 glass-panel md:rounded-none md:border-t-0 md:border-b-0 md:border-l-0 flex flex-col md:fixed h-auto md:h-screen z-20">
        ...
        <div className="p-4 border-t border-surfaceBorder">
          <div className="px-4 py-3 bg-surface border border-surfaceBorder rounded-lg mb-2">
          ...
          <button 
            ...
            className="w-full flex items-center gap-3 px-4 py-2 text-textMuted hover:bg-accent/10 hover:text-accent rounded-lg transition-all duration-200"
          >
